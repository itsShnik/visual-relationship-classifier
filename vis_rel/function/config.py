...
#-------------------------------------------------------------------------#
# Common options that I added
#-------------------------------------------------------------------------#
_C.EVAL_EVERY_EPOCH = True
_C.BATCH_SIZE = 256
_C.EVAL_BATCH_SIZE = 256
_C.RUN_MODE = 'train'
_C.NUM_WORKERS = 4
_C.MAX_EPOCH = 5
_C.FINAL_DIM = 768
...
_C.SCALES = ()
_C.VERSION='visual_relationships_classifier'
...
_C.TRAIN.GRAD_ACCUMULATE_STEPS = 2
_C.TRAIN.LR = 0.1
